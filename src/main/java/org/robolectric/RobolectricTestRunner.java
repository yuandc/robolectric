...
public class RobolectricTestRunner extends BlockJUnit4ClassRunner implements RobolectricTestRunnerInterface {
    public static final AndroidSdkFinder ANDROID_SDK_FINDER = new AndroidSdkFinder();
    ...
    public void setupApplicationState(Method testMethod) {
        ...
        ResourcePath systemResourcePath = configurer.findSystemResourcePath(config, ANDROID_SDK_FINDER);
